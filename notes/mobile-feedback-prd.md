...
| FB12 | Race chart general | Stretch x-axis to show every year                                                        | Core fix    | Code already flags this as deferred — needs a wider/scrollable axis, not a tweak.                                    | Not done |
