...
| `notes/design/interactions.md`    | The agreed interaction rules (2026-07-05, revised 2026-09-11), the five gated steps and the rank → race handoff in detail. |
...
| `scrolly/RankBars.svelte`, `GuessRank`, `PairQuiz`, `RaceScrubber`, `StartButton`, `RouteFilms` | The over-canvas panels and step controls (see "Panels").                                                                                                                                                                                                               |
