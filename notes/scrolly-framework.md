...
| `scrolly/layouts/*.js`                                               | One module per chart: `intro`, `hop-bands` (`hopSeed`, `hopBands` and `hopAnchor`, the cycling anchor), `chapters`, `rank`, `race`, `scatters`, `career`, `sim-race`. Each exports a `states` object; everything about one state is in its entry.                                                                                                                                                                                                                                                                            |
...
a state with their neighbour — both `hopBands` steps (5 and 7, with `hopAnchor`
