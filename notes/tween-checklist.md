...
| --- | --------------------------------------------- | --- | ---- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0   | `lone`                                        | [x] | [x]  | [ ]    | Cold start (no `?step`) must play the pop-in; a refresh on `?step=0` must not. Back arrives from 1.                                                                   |
| 1   | `networkIntro`                                | [x] | [x]  | [ ]    | Network grows out of `lone`. Tour caption appears only once settled; tap an actor to pin.                                                                             |
| 2   | `hopSeed`                                     | [x] | [x]  | [ ]    | Constellation pulls back; the bands' crowd parks behind it invisibly.                                                                                                 |
| 3   | `chapterCenters` — "The centers of Hollywood" | [x] | [x]  | [ ]    | Chapter card. Picture should hold still while the title fades in; title must be gone before 4 starts sorting.                                                         |
| 4   | `hopBands`                                    | [x] | [x]  | [ ]    | Crowd sorts into bands. Prose waits for `story.settled`.                                                                                                              |
| 5   | `hopBands`                                    | [ ] | [ ]  | [ ]    | Same state — text only, no dot tween. Back arrives from **6 and 7** (7 skips through 6); check both.                                                                  |
...
| 7   | `rankReveal`                                  | [ ] | [ ]  | [ ]    | Fwd via `GuessRank`'s own advance (not `go()`, so `navigate()` does not run). Back arrives from **8 and 9**.                                                          |
...
| 9   | `raceRecent`                                  | [ ] | [ ]  | [ ]    | Same state; the camera choreography from 8 lands here. Rank panel must stay up until `story.rankCollapsed`.                                                           |
| 10  | `raceFull`                                    | [ ] | [ ]  | [ ]    | Scrubber panel. Drag and slider on mobile; check the control clears the tap gutters.                                                                                  |
| 11  | `raceFuture`                                  | [ ] | [ ]  | [ ]    | Fixed camera, no scrubber.                                                                                                                                            |
| 12  | `chapterCenters` — "The makings of…"          | [ ] | [ ]  | [ ]    | Chapter card off a chart: the plot must dissolve into the full-bleed field.                                                                                           |
| 13  | `scatterCenters` `{showFilms}`                | [ ] | [ ]  | [ ]    | Field sorts into the scatter.                                                                                                                                         |
| 14  | `scatterCenters` `{showPair}`                 | [ ] | [ ]  | [ ]    | Portman/Kendrick pair reveal.                                                                                                                                         |
...
| 23  | `careerTrio`                                  | [ ] | [ ]  | [ ]    | Sweeney/De Niro/Chase trio. Its `revealFrom` points at `raceGenz`.                                                                                                    |
| 24  | `careerMany`                                  | [ ] | [ ]  | [ ]    | Trio fans out to the many. Back arrives from **25 and 26**.                                                                                                           |
| 25  | `simRace` (gate, skipback, advanceon)         | [ ] | n/a  | [ ]    | Must arrive at zero runs with a live Start (`resetSimRace`) on a forward arrival from outside the state. The run carries the reader to 26.                            |
| 26  | `simRace`                                     | [ ] | [ ]  | [ ]    | Settled chart — must keep the result, not re-run.                                                                                                                     |
| 27  | `raceClose`                                   | [ ] | [ ]  | [ ]    | Race chart's future view returns; SLJ's line falls away, contenders land on their medians.                                                                            |
| 28  | `outro`                                       | [ ] | [ ]  | [ ]    | Chart dissolves where it stands; canvas ends empty.                                                                                                                   |
