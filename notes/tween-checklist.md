...
| 4   | `hopBands`                                    | [!]                                                                                                                         | [!]                                                                                                | [ ]    | Crowd sorts into bands. Prose waits for `story.settled`.                                                                                                                                                    |
...
| 7   | `rankReveal`                                  | [!]                                                                                                                         | - [ ] bug (gets worse with &gt; 1 visit)                                                           | [ ]    | Fwd via `GuessRank`'s own advance (not `go()`, so `navigate()` does not run). Back arrives from **8 and 9**.                                                                                                |
