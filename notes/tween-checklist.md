...
| 26  | `simRace`                                     | [x]                                                                                                                         | [x]                                                                                                | [ ]    | Settled chart — must keep the result, not re-run.                                                                                                                             |
...
| 28  | `outro`                                       | [!]                                                                                                                         | [!]                                                                                                | [ ]    | Chart dissolves where it stands. Fwd now exits the wizard one-way into `#credits` (locked on `chapterCenters`'s ambient field) instead of doing nothing — no step follows it. |
